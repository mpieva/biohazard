...
dependency is linear (TODO: confirm), so we can store each genotype
likelihood as two coefficients.  This makes for 200 coefficient where
...
contamination rate.  (TODO: try and confirm)
