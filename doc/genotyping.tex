...
\idea{Hand-crafting partial derivatives of this equation doesn't seem to
yield anything that simplifies, so I'm inclined to apply Automatic
Differentiation and hand it over to my trusty Conjugate Gradient
solver.}
