...
probably because damage is a minor effect here.  On a 0.1\% divergent
dataset, naive genotype calling overestimates heterozygosity by a factor
of 15, but gets homozygous divergence right.  Running with the estimated
damage parameters gives a practically perfect result.} 
...
frequency at a time, holding the others constant\todo{Is this correct?
At any rate, multivariate maximization should do it.}.  Maximization is
...
the smaller BAM files on the fly.}
