...
handle in bases in ascending or descending order of quality; treat
errors on different strands as dependent or independent; various values
of $\theta$.  For $\theta = 1$, all of these should match the naïve
error model.}
